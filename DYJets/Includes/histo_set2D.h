#ifndef HISTO_SET2D_H
#define HISTO_SET2D_H
...
class histo_set2D
{
  ...
  public:
    /// \brief Constructor.
    explicit histo_set2D() = default;

    /// \brief Destructor.
    virtual ~histo_set2D() = default;
    ...
    template <class... Args> void declare(const std::string &name, const Args &... args)
    {
        ...
        _models.emplace(name, histogram_type(args...));
    }
