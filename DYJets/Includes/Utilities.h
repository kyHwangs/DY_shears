...
template <typename /*LEFT_TUPLE*/, typename /*RIGHT_TUPLE*/> struct join_tuples
{
};
...
template <typename T, unsigned N> struct generate_tuple_type
{
...
template <typename T> struct generate_tuple_type<T, 1>
{
    typedef std::tuple<T> type;
};
template <typename T> struct generate_tuple_type<T, 0>
{
